      ...
      <div className="bg-slate-300  bg-opacity-50 flex flex-col justify-center items-center tablet:3/5 laptop:w-2/5 phone:w-full">
        ...
        <form className="border-none flex-col px-5 phone:px-2 w-full phone:border-2  phone:rounded-b-md">
          ...
          <div className="flex flex-col justify-start my-2 w-full ">
            ...
            <div className="phone:flex-col tablet:flex w-full">
              <input
                className="phone:my-1 phone:w-full tablet:w-1/2 px-4 bg-white-200 appearance-none py-2 border-2 rounded text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple placeholder:text-sm"
                id="password"
                type="password"
