...
const DashboardUserButton = ({ item, isBlue = false }) => {
  ...
  return (
    <Link
      ...
      className={` transition-all  duration-200 text-white text-sm capitalize rounded-md w-full  h-8 laptop:h-10 flex-row-centered text-center gap-2 group px-2 z-10 ${
        isBlue
