...
const CourseCard = ({ courseID, courseImage, courseTitle }) => {
  return (
    <div className="flex flex-col justify-center items-center  mx-auto hover:scale-105 ease-in-out duration-300 ">
      <img
        src={`https://us-central1-elearning-module-a887d.cloudfunctions.net/app/s3Direct/${courseImage}`}
        alt="course image"
        className="bg-gray-300 h-44 w-56 laptop:w-56 laptop:h-60 rounded-lg shadow-md bg-cover bg-center"
      ></img>
      <div className="-mt-10 w-36 tablet:w-36 laptop:w-48 bg-white  shadow-lg rounded-lg overflow-hidden">
