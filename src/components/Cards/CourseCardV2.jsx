...
const CourseCardV2 = ({ courseID, courseImage, courseTitle }) => {
  return (
    <div className="group relative flex flex-col justify-between items-center w-full  h-[345px]   shadow-slate-300 shadow-xl bg-opacity-20  tablet:h-[320px] laptop:w-80 rounded-xl m-3 ">
      ...
      />
      <div className=" w-full flex justify-start gap-2 items-center py-2">
      ...
      <div className="w-full flex flex-row justify-end">
        <Link to={`/course/${courseID}`}>
          <button className="flex flex-row justify-center items-center px-4  gap-2 group-hover:font-bold group-hover:gap-4 text-sm h-8  font-extralight capitalize w-48 tablet:w-full laptop:w-48 bg-blue-800  text-white rounded-tl-xl rounded-br-xl">
