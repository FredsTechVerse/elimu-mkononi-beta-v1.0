...
const HeroSection = ({ isNavOpen, showNavbar, hideNavbar }) => {
  return (
    <div className="relative homepage w-full  flex items-center justify-center h-[90vh]">
      <Navbar
        isNavOpen={isNavOpen}
      ...
      <div className="text-white w-full tablet:w-3/5 text-center flex-col-centered">
        ...
        <p className="text-md font-extralight ">
          ...
          labore facere, totam delectus quidem eligendi nihil aliquid dolor esse
          deleniti? Sequi nemo dolore asperiores omnis natus, repudiandae,
        </p>
        <a
          href="#courses"
