...
const UnitNav = ({ unitData }) => {
  ...
  return (
    <div className="navigation flex flex-row w-full justify-between gap-10 items-center text-dark  text-sm text-white bg-primary pl-2 pr-4 h-14 rounded-bl-lg ">
      <div>
