...
const TutorDashboard = () => {
  ...
  return (
    <div className="w-full p-5 grid phone:grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-5 m-3 ">
      ...
      <div className="greetings col-start-1 col-span-2 row-span-1  flex-row-centered bg-slate-300 rounded-xl h-48 flex">
      ...
      {/* <div className="w-full debug tablet:w-4/5 laptop:w-2/3 aspect-[2/3] h-full  py-3 px-4 grid phone:grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-4 "> */}
      {tutorData &&
