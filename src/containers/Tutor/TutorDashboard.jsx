...
const TutorDashboard = () => {
  ...
  return (
    <div className="w-full p-5 grid phone:grid-cols-1 tablet:grid-cols-3 laptop:grid-cols-4 gap-5 m-3 ">
      <div className="col-span-1">
        <div className="flex flex-col items-start justify-center phone:col-span-1 phone:row-span-2  tablet:row-start-2 tablet:col-start-1 tablet:col-span-2 laptop:col-start-3 laptop:row-start-1 laptop:col-span-1 laptop:row-span-3 ">
          ...
          <div className="controls w-full h-full flex-col-centered">
            <h1 className="text-slate-900 font-bold text-lg capitalize mt-3 w-full h-12 flex-row-centered  ">
      ...
      <div className="tablet:col-span-2 laptop:col-span-3 grid tablet:grid-cols-3 gap-4">
        <div className="greetings col-start-1 col-span-3 row-span-1  flex-row-centered rounded-xl h-48 flex">
